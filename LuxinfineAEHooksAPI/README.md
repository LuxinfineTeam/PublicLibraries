...
v6.9
- Запрет возможности вывода виртуальных предметов через мэ интерфейсы из кластера автокрафта через кодирование шаблонов с использованием виртуальных предметов как ингредиентов

v6.10
- Ускорение метода AEConverters#boxFluid за счёт кеша
...
v7.1
- Замена хука в CellInventory#injectItems на ASM: фикс чрезмерной аллокации Object[] / IHookContext в горячем вызове